...
fname: Yup.string().required(t('errors.fname.required')).matches(/^[aA-zZ\s]+$/, t('errors.fname.letters_only')),
    ...
    return (
        ...
        <form>
            ...
            <div id="input-div" key={element.code}>
                ...
                <input placeholder={t(`labels.${element.code}`)} {...register(element.code,{required:"req"})} defaultValue={state[element.code]}/>
                <span>
            ...
            <button type="submit" onClick={(e) =>{
             ...
             }}>{t('buttons.forwardButton')}</button>
             </div>
 </div>       
        )
}
